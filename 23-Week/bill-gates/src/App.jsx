...
function App() {
  const [totalBalance, setTotalBalance] = useState(100000000000);
  ...
  return (
    <div className='title'>
      <img src="https://neal.fun/spend/billgates.jpg" alt="" className='bill-img' />
      <p className='title-p'>Spend Bill Gates' Money</p>
      <p className='balance button-click' >Total Balance: $ {totalBalance}</p>
