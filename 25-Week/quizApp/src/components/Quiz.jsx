        ...
        <div className="quiz-container">
            {!quizStarted ? (
                ...
                <div className="quiz-question">
                    ...
                    {timeRemaining <= 20 && <Options options={questions[currentQuestionIndex].options} onSelectOption={handleSelectOption} />}
                ...
                <div className="quiz-results">
                    {showResults ? (
                        ...
                        <div className="quiz-finish">
                            <p>Soruları bitirdin! Sonuçları görmek için bitir.</p>
